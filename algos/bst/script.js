...
// During insertion or deletion visualization process disable the buttons
const freezeButtons = () => {
...
const update = (oldData, newData, parentValue, childValue) => {
  ...
  */
  ...
  // Convert both trees from objects to array.
...
const deleteNode = async () => {
  ...
  // Copying object without reference in a dirty way. 
  let oldData = JSON.parse(JSON.stringify(data));
  let newData = JSON.parse(JSON.stringify(data));
  let node = newData;
  let parent = null;
